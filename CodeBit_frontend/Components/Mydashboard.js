...
const Mydashboard = (props) => {
  const { info, snip, token, details, setDetails, update, edit, setEdit } =
    props;
  ...
  return (
    <>
      <div
        className={`bg-secondary_bg md:ml-40 min-h-screen max-h-full lg:flex  ${sty.height} `}
      >
        <div className="lg:w-2/3 w-full drop-shadow-lg	 xs:px-3 sm:px-10  py-3">
          <div className="xs:px-3 sm:px-10 py-3 h-18  bg-blue-50 overflow-hidden flex justify-between ">
            <p
              className={`text-black text-lg font-semibold mt-3  text-center tracking-wider `}
            >
              My Dashboard
            </p>
            <div className="w-7 h-6 mt-3 py-0 cursor-pointer">
              <Image
                src={pen}
                alt="edit"
                onClick={handleedit}
          ...
          <hr className="m-0 mx-3 text-blue-600" />
            <div className="block md:flex  xs:px-3 sm:px-10">
              ...
              <div className="xs:w-full md:w-3/5 py-4 xs:px-10 md:px-3 xs:flex xs:justify-between md:block">
                <div>
                  <p className="font-Ubuntu text-black font-medium ">Languages</p>
                ...
                <div>
                  <p className="font-Ubuntu text-black font-medium mb-2 xs:mt-0 md:mt-4 ">
                    Links
                  </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full xs:px-5 sm:px-10  py-4 bg-thr_bg">
              <div className="xs:col-span-2 sm:col-span-1">
                <label className="block text-secondary_text font-medium">Username</label>
                <input
                  type="text"
                  ...
                  className={`w-full px-4 py-2.5  rounded-lg  ${
                    edit.readOnly
                      ? "bg-section_bg text-primary_text"
                      : "bg-text_prime text-section_secondary font-semibold"
                  }   mt-2 focus:ring focus:ring-section_bg focus:outline-none`}
              ...
              <div className="xs:col-span-2 sm:col-span-1">
                <label className="block text-secondary_text font-medium">Name</label>
                <input
                  type="text"
                  placeholder="Name"
                  name="fullname"
              ...
              <div className="col-span-2 ">
                <label className="block text-secondary_text font-medium">Email</label>
                <input
                  type="text"
                  placeholder="Email"
                  name="Email"
              ...
              <div className="xs:col-span-2 sm:col-span-1">
                <label className="block text-secondary_text font-medium">Location</label>
                <input
                  type="text"
              ...
              <div className="xs:col-span-2 sm:col-span-1">
                <label className="block text-secondary_text font-medium">
                  Occupacation
                </label>
                <input
                  type="text"
              ...
              <div className="col-span-2 ">
                <label className="block text-secondary_text font-medium">Bio</label>
                <textarea
                  placeholder="Bio"
                  name="bio"
                  id="bio"
