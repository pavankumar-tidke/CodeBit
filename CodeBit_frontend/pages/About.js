...
export default function About() {
  return (
    <>
      ...
      {/* <Nav /> */}
      <section className="text-black bg-primary_bg border-t border-section_bg body-font">
          ...
          <div className="flex xs:justify-center flex-wrap -m-4">
            <div className="p-4 lg:w-1/2">
              <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                <div className="rounded-full w-48 h-48 object-cover object-center sm:mb-0 mb-4">
                  <Image
                ...
                <div className="flex-grow sm:pl-8">
                  <h2 className="title-font  text-blue-600 font-bold">
                    Pavankumar Tidke
                  </h2>
